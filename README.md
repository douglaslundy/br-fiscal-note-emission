...
- `references/reference-system-map.md` — scope checklist of a complete fiscal module (pipeline, orchestrator, jobs, contingency, received notes, product fiscal data, SaaS layer, screens, known risks).
